...
/**
 * Spring AI 模型框架调用 AI 大模型 （Ollama）
 *
...
public class OllamaAiAiInvoke implements CommandLineRunner {
    ...
    @Resource
    private ChatModel ollamaChatModel; // 先通过名称 找不到再通过类型 一定要是这个名称

    @Override
    public void run(String... args) throws Exception {
        AssistantMessage assistantMessage = ollamaChatModel.call(new Prompt("你好，我是秋棠"))
                .getResult()
