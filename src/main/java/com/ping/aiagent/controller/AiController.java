...
public class AiController {
    ...
    /**
     * SSE 流式调用 AI 恋爱大师应用 - 方式 1 - 简单，伪实现
     *
     * @param message
     * @param chatId
     * @return
    ...
    public SseEmitter doChatWithLoveAppSeeEmitter(String message, String chatId) {
